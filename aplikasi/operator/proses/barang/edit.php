...
<div class="card border-primary shadow">
	...
	while($d = mysqli_fetch_array($data)){
		...
		<form method="post" action="edit_barang.php">		
					...
					<input type="hidden" name="id_barang" class="input-text form-control" value="<?php echo $d['id_barang']; ?>">
					<input type="text" name="nama_barang" class="input-text form-control" value="<?php echo $d['nama_barang']; ?>">
					<label><b>Kode Jenis</b></label>
					<input type="text" name="kode_barang" class="input-text form-control" value="<?php echo $d['kode_barang']; ?>">
